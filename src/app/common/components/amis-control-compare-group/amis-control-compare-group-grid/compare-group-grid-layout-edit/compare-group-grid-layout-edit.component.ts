...
@Component({
  selector: 'amis-compare-group-grid-layout-edit',
  templateUrl: './compare-group-grid-layout-edit.component.html',
  styleUrls: ['./compare-group-grid-layout-edit.component.scss']
})
export class CompareGroupGridLayoutEditComponent extends BaseComponent implements OnInit {

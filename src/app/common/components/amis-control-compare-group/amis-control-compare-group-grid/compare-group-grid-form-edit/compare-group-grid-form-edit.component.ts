...
@Component({
  selector: 'amis-compare-group-grid-form-edit',
  templateUrl: './compare-group-grid-form-edit.component.html',
  styleUrls: ['./compare-group-grid-form-edit.component.scss']
})
export class CompareGroupGridFormEditComponent extends BaseComponent implements OnInit {
  ...
  saveDataEdit() {
    ...
    // Nếu không gọi api
      ...
      this.objectData = this.setDataAfterSave(AmisCommonUtils.cloneDeepData(this.objectData));

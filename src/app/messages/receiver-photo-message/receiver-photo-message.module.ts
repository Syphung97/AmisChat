...
import { ReceiverPhotoMessageComponent } from './receiver-photo-message.component';
...
@NgModule({
  ...
  exports: [ReceiverPhotoMessageComponent]
})
export class ReceiverPhotoMessageModule { }

...
@Component({
  selector: 'amis-receiver-video-message',
  templateUrl: './receiver-video-message.component.html',
  styleUrls: ['./receiver-video-message.component.less'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ReceiverVideoMessageComponent extends BaseComponent implements OnInit {
